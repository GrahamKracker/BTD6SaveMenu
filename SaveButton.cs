...
public class SaveButton
{
    ...
    private static void CreatePanel(GameObject screen)
    {
        ...
        button = buttonPanel.AddButton(new Info("SaveChanger", -1410, 130, 350, 350, new Vector2(1, 0), new Vector2(0.5f, 0)), ModContent.GetSpriteReference<Main>("ModsBtn").GUID, new Action(opensavemenu));
